    ...
    def expandMacros(member: PMember): PMember = {
      ...
      val expander =
        everywheretd(rule[PAstNode] {
          ...
          case proc @ PProcedure(name, ins, outs, inters, level, pres, posts, locals, body, atomicity, lemma) =>
            ...
            val newChildren: Array[AnyRef] =
              Array(name, ins, outs, inters, level, pres, posts, locals ++ additionalLocals, body, atomicity, lemma)
